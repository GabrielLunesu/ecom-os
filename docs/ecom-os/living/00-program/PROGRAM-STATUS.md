...
last_verified_against: ddaaaa2d128bcb901e8d9ffdb893004a04a5fe52
---
...
`origin/agent/a00-orchestrator` and `origin/coordination/program`, both then at `ddaaaa2`,
...
A00-owned programme-file edits, and real Hermes conformance is blocked. The interface
registry remains proposed-only.
...
A03 and A06 have committed edits, A04 has staged edits, and A08 has local edits to
A00-owned files under `docs/ecom-os/living/00-program/**`. A00 will not copy those files
