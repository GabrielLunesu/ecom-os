...
This is a lightweight, operator-friendly checklist for releasing the software.
...
- [ ] If migrations are risky or not back ward compatible, schedule a maintenance window.
